...
local _data = {
	...
	fish = {
		s2c = {
			...
			[0x020011] = "fish.s2c.UserSkillStatus",
			[0x020012] = "fish.s2c.UserFort",
			-- [0x020013] = "fish.s2c.UserLockFish",
			[0x020014] = "fish.s2c.YnchronizationDataErr",
			[0x020015] = "fish.s2c.CallFish", 
			[0x020016] = "fish.s2c.NotifyFishRate", 
			[0x020017] = "fish.s2c.FrozenFish", 
		...
		c2s = {
			...
			[0x02000F] = "fish.c2s.BigNetCatchFishAndroid",
			[0x020011] = "fish.c2s.UserSkillStatus",
			[0x020012] = "fish.c2s.UserFort",
			-- [0x020013] = "fish.c2s.UserLockFish",
			[0x020015] = "fish.c2s.CallFish", 
		},
		files = {
			"fish.c2s.pb",
			"fish.s2c.pb",
...
local conf = getConfig("loginServer")
print("----------------------------------------------------------------------------------------------------------------")
...
for protoNo, typeName in pairs(conf.c2s) do
	print(string.format("protoNo:0x%06X,typeName:%s",protoNo,typeName))
end	
