...
//#define MAX_READ_BUFFER 4096 // su_start
...
#define MALLOC network_malloc
#define FREE network_free
...
socket_info_create(struct socket_info *last) {
	...
	//su_start
	struct socket_info *si = (struct socket_info *)network_malloc(sizeof(*si));
