...
void test_TingCardTips()
{
	...
	for (int i = 0; i < 2; i++)
	{
		...
		std::stringstream ss_out_card_index;
		ss_out_card_index << "out_card_index_" << i;
		...
		for (int j = 0; j < 2; j++)
		{
			...
			std::stringstream ss_hu_card_index;
			ss_hu_card_index << "hu_card_index_" << j;
			rapidjson::Value value_hu_card_index(rapidjson::Type::kStringType);
			value_hu_card_index.SetString(ss_hu_card_index.str().data(), ss_hu_card_index.str().size(), docOperate_allocator);
			...
			valueCPGNotify_ting_card_tips_index_hu_card_tips.AddMember(value_hu_card_index, valueCPGNotify_ting_card_tips_index_hu_card_tips_hu_card, docOperate_allocator);
