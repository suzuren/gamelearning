...
int _bio_read(struct tls_context* tls_p);
...
int _ltls_context_handshake(struct tls_context* tls_parm, size_t slen, const char* exchange);
...
int lnew_ctx();
int lnew_tls(const char* method_parm, struct ssl_ctx* ctx_parm);
